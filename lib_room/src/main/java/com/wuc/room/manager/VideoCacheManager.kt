package com.wuc.room.manager

import androidx.lifecycle.LiveData
import com.wuc.room.database.WucDataBase
...
/**
 * @author     wuchao
 * @date       2023/7/25 00:36
 * @desciption 视频缓存管理类
 */
object VideoCacheManager {

    private val videoDao by lazy { WucDataBase.getInstance().videoListDao() }
