package com.wuc.framework.widgets
...
/**
 * @author     wuchao
 * @date       2023/7/22 00:31
 * @description 带清除按钮的 EditTextView
 */
class ClearEditText @JvmOverloads constructor(
     ...
     * 我们将此视为进行清除操作
     * width:得到控件的宽度
     * event.x:抬起时的坐标(该坐标是相对于控件本身而言的)
     * totalPaddingRight:clean的图标左边缘至控件右边缘的距离
     * paddingRight:clean的图标右边缘至控件右边缘的距离
     *
     * 于是:
     * width - totalPaddingRight 表示: 控件左边到clean的图标左边缘的区域
     * width - paddingRight表示: 控件左边到clean的图标右边缘的区域
