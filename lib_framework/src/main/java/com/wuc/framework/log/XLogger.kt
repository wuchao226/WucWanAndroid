...
class XLogger {
     ...
     * 初始化xlog
     */
    fun init(context: Application, isDebug: Boolean, logPath: String, namePrefix: String = "wucTea") {
        System.loadLibrary("c++_shared")
        System.loadLibrary("marsxlog")

        val cachePath = context.filesDir.absolutePath + "wucTea/xlog"
