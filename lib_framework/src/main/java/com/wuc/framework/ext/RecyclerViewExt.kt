...
import com.wuc.framework.decoration.WucDividerItemDecoration

/**
 * Description：一行代码快速实现添加垂直分割线，网格分割线；
 */
...
fun RecyclerView.divider(
    ...
    val decoration = WucDividerItemDecoration(context, orientation)
